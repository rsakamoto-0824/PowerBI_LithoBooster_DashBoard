...
| グループ | 対象ページ | 内容 |
|---|---|---|
| 期間・装置 | 全7ページ | 日付[Date]・装置[EQPID]は全ページで選択を共有 |
| ○○_Canon（6グループ） | P1/P2/P3/P7 | DEVICE_TYPE・OPERATION・LOT_ID・WAFER_ID・PROCESS・PRODUCT（CANON列） |
| ○○_Nikon（6グループ） | P4/P5/P6 | 同上（NIKON列） |
